...
impl Sysvia {
    ...
    pub fn set_ca1_level(&mut self, level: bool) {
        unsafe {
            sysvia_set_ca1(self.via, level as u32);
        }
    }
}
...
#[no_mangle]
pub extern "C" fn raise_interrupt(state: *mut State, value: u32) {
...
fn key_update(state: *mut State) {
    ...
    unsafe {
        sysvia_set_ca2(cvia, scan as u32);
    }
}

#[no_mangle]
pub extern "C" fn key_scan(state: *mut State, row: u32, col: u32) {
    let keyboard = unsafe { &mut (*state).keyboard };
...
#[no_mangle]
pub extern "C" fn key_is_down(state: *const State) -> bool {
...
#[no_mangle]
pub extern "C" fn crtc_latchpen() {
    unimplemented!("6845 lightpen");
}

#[no_mangle]
pub extern "C" fn sn_write(data: u8) {
    println!("sn76489 data: {data}");
}

#[no_mangle]
pub extern "C" fn led_update(led_name: u32 /* led_name_t */, b: bool, ticks: u32) {
    println!("LED update: led_name={led_name}, b={b}, ticks={ticks}");
}

#[no_mangle]
pub extern "C" fn key_paste_poll(state: *mut State) {
